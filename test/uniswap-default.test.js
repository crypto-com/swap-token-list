...
const {buildMainnetList,buildRopstenList} = require('../src/buildList');

const ajv = new Ajv({ allErrors: true, format: 'full' });
const validator = ajv.compile(schema);

describe('buildMainnetList', () => {
  const defaultTokenList = buildMainnetList();
...
describe('buildRopstenList', () => {
  const defaultTokenList = buildRopstenList();
